/* eslint-disable no-tabs, no-shadow-restricted-names, no-var */
var ob = ob || {};
...
;(function(namespace, undefined) {
  ...
  namespace.treemap = function() {
    ...
    const _on_handlers: Record<string, ((...args: Array<any>) => any) | undefined> = {};
  ...
  _current_display = disp2;
    ...
    return {
      ...
      display: function(element, d) {
        ...
        // This keeps old callers working while allowing simpler integrations.

...
d3.json("/data/sacbudget_v3.json", function (root) {
  initialize(root);
  accumulate(root);
  accum2(root);
  layout(root);
  ...
  function display(d) {
    ...
    g.on("mouseover", function (d) {
      ...
      div.html("<br/>" + d.name + "<br/> <br/>" + "2017/18 (Proposed) :     " + dollarformat(d.amount2018) + " <br/> 2016/17 (Actual) :     " + dollarformat(d.amount2017) + "<br/> <br/>" + (d.desc != null ? d.desc : ""))
  ...
  function rect(rect) {
    rect.attr("x", function (d) { return x(d.x); })
      ...
      .attr("fill", function (d) { return isNaN((parseFloat(d.amount2018) / parseFloat(d.amount2017) - 1) * 100) ? color(0) : color((parseFloat(d.amount2018) / parseFloat(d.amount2017) - 1) * 100); });
  }

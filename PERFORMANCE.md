...
## CI/CD Enforcement
- CI (`.github/workflows/ci.yml`) runs lint, unit coverage (CI), i18n smoke, a11y, perf report, benchmarks, JSDoc generation, Eleventy build checks, built-site i18n sanity checks, and Puppeteer E2E.

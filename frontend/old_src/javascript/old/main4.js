$(function() {
	...
	//Default year cuts
    const cuts = {"time.year": "2013"}
	//Default header text
	const headerText = "Mayor's Proposed Two-Year Spending (2013-15)"
    ...
    const crumbs = [{path:path, title:'Funds'}]
	...
	siteUrl: "http://openspending.org",
		...
		const new_location = [window.location.href,
